                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/QuickBaluchon/QuickBaluchon/backend/actions/client_delete_account.php?company_name=<?php echo $user['company_name']; ?>" class="btn btn-danger" role="button" style="margin: 2px;"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
