        ...
        <div class="col-md-4">
            <img src="../img/utilisateur-de-profil.png" alt="Profil" class="w-100">
                ...
                <div class="col-md-8 px-3">
                    ...
                    <h4 class="card-title"><?php echo $result['company_name']; ?></h4>
                    <p class="card-text"><small class="text-muted"><?php echo $result['mail']; ?></small></p>
                    <p class="card-text"><?php echo $result['billing_address']; ?></p>
                    <p class="card-text"><?php echo $result['siret_nb']; ?></p>
                    <p class="card-text"><?php echo $result['motives']; ?></p>
                    </div>
                </div>
            </div>
        </div>
